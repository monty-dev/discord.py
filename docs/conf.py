...
intersphinx_mapping = {"py": ("https://docs.python.org/3", None), "aio": ("https://docs.aiohttp.org/en/stable/", None), "req": ("http://docs.python-requests.org/en/latest/", "requests.inv")}
...
texinfo_documents = [
    ("index", "discord.py", "discord.py Documentation", "Rapptz", "discord.py", "One line description of project.", "Miscellaneous"),
]
